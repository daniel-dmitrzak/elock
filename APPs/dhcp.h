...
********************************************************************************
*/
extern void send_DHCP_DISCOVER(uint8_t s);
extern void send_DHCP_REQUEST(uint8_t s, uint8_t *Cip, uint8_t *d_addr);
extern void send_DHCP_REREQUEST(uint8_t s);
extern void send_DHCP_RELEASE(uint8_t s);
extern void send_DHCP_DECLINE(uint8_t s);

extern unsigned char getIP_DHCPS(void);
extern void check_DHCP_state(void);
extern void check_Timeout(void);

extern char parseDHCPMSG(uint8_t s, uint16_t length);
